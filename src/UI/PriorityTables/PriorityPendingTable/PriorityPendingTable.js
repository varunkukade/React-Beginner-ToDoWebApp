...
import classes from "./PriorityPendingTable.css";

class priorityPendingTable extends Component {
  state = {
    tasks: [],
  };
...
export default priorityPendingTable;
